...
namespace Greet {
    ...
    static GreetingReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "YW1lGAEgASgJEhAKCGxhc3ROc21lGAIgASgJIjQKD0dyZWV0aW5nUmVxdWVz",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Greet.Greeting), global::Greet.Greeting.Parser, new[]{ "FirstName", "LastNsme" }, null, null, null, null),
  ...
  #endif
  {
    ...
    /// <summary>Field number for the "lastNsme" field.</summary>
    public const int LastNsmeFieldNumber = 2;
    private string lastNsme_ = "";
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public string LastNsme {
      get { return lastNsme_; }
      set {
        lastNsme_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }
    ...
    public bool Equals(Greeting other) {
      ...
      if (LastNsme != other.LastNsme) return false;
    ...
    public override int GetHashCode() {
      ...
      if (LastNsme.Length != 0) hash ^= LastNsme.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LastNsme.Length != 0) {
        output.WriteRawTag(18);
        output.WriteString(LastNsme);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (LastNsme.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeStringSize(LastNsme);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(Greeting other) {
      ...
      if (other.LastNsme.Length != 0) {
        LastNsme = other.LastNsme;
      }
